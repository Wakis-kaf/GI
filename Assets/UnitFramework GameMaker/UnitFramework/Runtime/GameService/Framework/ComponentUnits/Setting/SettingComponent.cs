...
{
    public class SettingComponent : SingletonComponentUnit<SettingComponent>, IController, IUnitDestroy
    {
        ...
        {
            base.OnUnitAwake();
            m_SettingManager = GameFramework.Container.FindHelper<ISettingManager>();
            ...
            {
                Log.DebugInfo("Load Setting Success");
            }
        }
        
        public  void OnUnitDestroy()
        {
            m_SettingManager.Shutdown();
        ...
        {
            m_SettingManager.Update(Time.deltaTime,Time.unscaledDeltaTime);
        }
        /// <summary>
        /// 保存游戏配置。
        /// </summary>
