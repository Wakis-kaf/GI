...
using UnityEngine;
using Utility  = UnitFramework.Utils.Utility;
namespace UnitFramework.Runtime
{
    ...
    public class DefaultSettingHelper : SettingHelperBase
    {
        ...
        public override bool Load()
        {
            ...
            {
                Log.WarnFormat("Load settings failure with exception '{0}'.", exception.ToString());
                return false;
            }
        }
        ...
        public override bool Save()
        {
            try
            {
                Log.Info("Saving Settings path"+m_FilePath);
            ...
            {
                Log.WarnFormat("Save settings failure with exception '{0}'.", exception.ToString());
                return false;
            }
        }
        ...
        public override T GetObject<T>(string settingName, T defaultObj)
        {
            ...
            return Utils.Utility.Json.ToObject<T>(json);
        }
