...
namespace UnitFramework.Runtime
{
    ...
    public sealed class SettingManager : ISettingManager
    {
        ...
        {
            this.m_SettingHelper = (ISettingHelper) null;
        }
        ...
        public int Count
        {
            get
            {
                if (this.m_SettingHelper == null)
                    throw new UnitFrameworkException("Setting helper is invalid.");
                return this.m_SettingHelper.Count;
            }
        }
        ...
        public void SetSettingHelper(ISettingHelper settingHelper)
        {
            if (settingHelper == null)
                throw new UnitFrameworkException("Setting helper is invalid.");
            this.m_SettingHelper = settingHelper;
        }
        ...
        public bool Load()
        {
            if (this.m_SettingHelper == null)
                throw new UnitFrameworkException("Setting helper is invalid.");
            return this.m_SettingHelper.Load();
        }
        ...
        public bool Save()
        {
            if (this.m_SettingHelper == null)
                throw new UnitFrameworkException("Setting helper is invalid.");
            return this.m_SettingHelper.Save();
        }
        ...
        public string[] GetAllSettingNames()
        {
            if (this.m_SettingHelper == null)
                throw new UnitFrameworkException("Setting helper is invalid.");
            return this.m_SettingHelper.GetAllSettingNames();
        }
        ...
        public bool HasSetting(string settingName)
        {
            ...
            if (string.IsNullOrEmpty(settingName))
                throw new UnitFrameworkException("Setting name is invalid.");
            return this.m_SettingHelper.HasSetting(settingName);
        }
        ...
        public bool RemoveSetting(string settingName)
        {
            ...
            if (string.IsNullOrEmpty(settingName))
                throw new UnitFrameworkException("Setting name is invalid.");
            return this.m_SettingHelper.RemoveSetting(settingName);
        }
        ...
        public bool GetBool(string settingName)
        {
            ...
            if (string.IsNullOrEmpty(settingName))
                throw new UnitFrameworkException("Setting name is invalid.");
            return this.m_SettingHelper.GetBool(settingName);
        }
        ...
        public int GetInt(string settingName)
        {
            ...
            if (string.IsNullOrEmpty(settingName))
                throw new UnitFrameworkException("Setting name is invalid.");
            return this.m_SettingHelper.GetInt(settingName);
        }
        ...
        public float GetFloat(string settingName)
        {
            ...
            if (string.IsNullOrEmpty(settingName))
                throw new UnitFrameworkException("Setting name is invalid.");
            return this.m_SettingHelper.GetFloat(settingName);
        }
        ...
        public string GetString(string settingName)
        {
            ...
            if (string.IsNullOrEmpty(settingName))
                throw new UnitFrameworkException("Setting name is invalid.");
            return this.m_SettingHelper.GetString(settingName);
        }
        ...
        public T GetObject<T>(string settingName)
        {
            ...
            if (string.IsNullOrEmpty(settingName))
                throw new UnitFrameworkException("Setting name is invalid.");
            return this.m_SettingHelper.GetObject<T>(settingName);
        }
